...
function getEndpoints(deviceAddress, endpoints) {
    ...
    var uv = endpoints.addEndpoint("4", "UV Index", endpointType.genericSensor);
    uv.variableTypeId = 1286;
    var windspeed = endpoints.addEndpoint("5", "Wind Speed", endpointType.genericSensor);
    windspeed.variableTypeId = 1287;
    var winddirection = endpoints.addEndpoint("6", "Wind Direction", endpointType.genericSensor);
    winddirection.variableTypeId = 1284;
    var rainfall = endpoints.addEndpoint("7", "Rainfall Intensity", endpointType.genericSensor);
    rainfall.variableTypeId = 1288;
    endpoints.addEndpoint("8", "Barometric Pressure", endpointType.pressureSensor);
}
